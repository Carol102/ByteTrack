...
def main(exp, args):
    ...
    if args.demo == "image":
       ...
       return imageflow_demo(predictor, vis_folder, current_time, args,exp)
...
# def main_parse(demo,path,exp_file="exps/example/mot/yolox_x_mix_det.py",ckpt="pretrained/bytetrack_x_mot17.pth.tar"):
#     args = MainParse()
#     args.demo = demo
#     args.path = path
#     args.exp_file = exp_file
#     args.ckpt = ckpt
#     # make_parser(demo,path,exp_file,ckpt).parse_args()
#     exp = get_exp(args.exp_file, args.name)
